...
interface CarRepository extends JpaRepository<Car, Integer> {
    ...
    @Query("select new pl.dkobylarz.garage_system_api.car.dto.CarDto(c.carId, c.carModel.modelName, c.carBrand.brandName, c.carMileage, c.carPhotoUrl, c.yearOfProduction, c.createdDate, c.lastUpdated) from Car c where c.userId = :userId and c.active = true")
